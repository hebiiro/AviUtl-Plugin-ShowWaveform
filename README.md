...
* 7.3.3 - 2025/06/25 🩹1個目のアイテムの音声波形が表示されない問題に対応
* 7.3.2 - 2025/06/24 🩹動画と連携している場合に波形が描画されないことがある問題に対応
* 7.3.1 - 2024/11/11 🩹アイテムを一定数追加したときエラーになる問題に対応
* 7.3.0 - 2024/03/16 指定されたアイテムを除外できる機能を追加
