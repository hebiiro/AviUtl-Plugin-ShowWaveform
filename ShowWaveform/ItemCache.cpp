...
AudioParamsPtr ItemCacheManager::getAudioParams(ExEdit::Object* object)
{
	...
	auto fps = (float)theApp.m_fi.video_rate / theApp.m_fi.video_scale;
	...
	if (object->check_value[1])
	{
		if (auto object2 = get_movie_file_item(object))
		{
			...
			auto video_fps = (float)exdata->video_rate / exdata->video_scale;

			copyFileName(params->fileName, sizeof(params->fileName), exdata->file);
			params->playBegin = (int32_t)(object2->track_value_left[playBeginIndex] * fps / video_fps);
	...
	else
	{
		...
		copyFileName(params->fileName, sizeof(params->fileName), exdata->file);
		params->playBegin = (int32_t)(object->track_value_left[playBeginIndex] * fps / 100.0f);
...
//
ExEdit::Object* ItemCacheManager::get_movie_file_item(ExEdit::Object* object)
{
