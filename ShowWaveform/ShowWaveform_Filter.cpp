...
int track_def[] = {  10,  10,  80, 0 };
int track_min[] = {   1,   1,   1, 0 };
int track_max[] = { 600, 800, 400, 2 };
...
//		FILTER_FLAG_NO_CONFIG | // このフラグを指定するとウィンドウが作成されなくなってしまう。
		...
		FILTER_FLAG_AUDIO_FILTER | // このフラグがないと「設定」の方にウィンドウを表示するための項目が追加されてしまう。
